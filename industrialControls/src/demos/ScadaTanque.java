 ...
 * @author marcoisaac
 */
public class ScadaTanque extends Application {
    ...
    public void start(Stage stage) throws Exception {
        ...
        Image image = new Image(ScadaTanque.class.getResourceAsStream("pipa.png"));
        ...
        PipePath path3 = new PipePath(root, 240, 446);
        path3.setH(60);
        path3.add(new CurveElement(CurveDirection.BOTTOM_LEFT));
        path3.add(new RectElement(RectDirection.RIGHT_LEFT, 1));
        ...
        pane.setVgap(5);
        pane.setHgap(7);
        pane.setPadding(new Insets(7, 0, 0, 40));
