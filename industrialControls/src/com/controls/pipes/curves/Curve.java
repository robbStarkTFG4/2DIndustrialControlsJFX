...
public class Curve extends Control implements PointLocator {
    ...
    public Curve(PipePath path, CurveDirection direction, double startX, double startY, double W, double H, double T, double AV) {
        ...
        this.AV = AV;
        this.EDGE = AV - 1;
        // use switch to calculate curve endPoint here
        // RIGHT_DOWN, RIGHT_UP, LEFT_DOWN, LEFT_UP, //CURVES
        double EndPointX = 0;
        double EndPointY = 0;
    ...
    private void findEndPoint(CurveDirection direction1, double W1, double H1, double startX1, double T1, double startY1, double AV1) {
        ...
        switch (direction1) {
            ...
            case UP_LEFT:
                ...
                this.endPoint = new Point(EndPointX, EndPointY);
                break;
            case LEFT_UP_2:// aqui estoy trabajando
                //
    ...
    protected Skin<?> createDefaultSkin() {
        ...
        switch (direction) {
            ...
            case RIGHT_UP:
                CurveThree curve1 = new CurveThree(this);
                drawer = curve1;
                return curve1;
            ...
            case LEFT_UP:
                ...
                //drawer = curve3;
                CurveThree curve3 = new CurveThree(this);
                drawer = curve3;
                return curve3;
